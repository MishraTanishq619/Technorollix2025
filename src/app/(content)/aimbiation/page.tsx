      ...
      <section className="mx-auto my-40">
        <div className="flex flex-col md:flex-row mt-10 mx-6 items-center justify-center text-center md:text-left">
                ...
                <div className="text-center md:text-left">
                  ...
                  aiMBiAtion isn&apos;t just a management fest—it&apos;s a space where ideas take flight, creativity finds its voice, and competition turns into camaraderie. Hosted by OP Jindal University,  t&apos;s a perfect blend of business, culture, and fun, bringing together dreamers, doers, and disruptors for an experience 
                    <Link href="/about">
