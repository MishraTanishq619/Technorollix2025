      ...
      <section>
        ...
        <section>
          <div className="flex justify-around m-20">
            <SubEventCard
              Icon={GiTargetPoster} // Updated path
          ...
          <div className="flex justify-around m-20">
            <SubEventCard
              Icon={IoIosColorPalette } // Updated path
            ...
            />
            <SubEventCard
              Icon={ FaBottleDroplet } // Updated path
